> **Note**: original code from [github.com/Esri/jsapi-resources/tree/master/esm-samples/jsapi-node](https://github.com/Esri/jsapi-resources/tree/master/esm-samples/jsapi-node)
