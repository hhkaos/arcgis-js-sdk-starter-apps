...
- [Run 3rd party JS libraries with TypeScript](#run-3rd-party-js-libraries-with-typescript)
  ...
  - [Run ArcGIS API using ESM + TypeScript using Rollup.js](#run-arcgis-api-using-esm--typescript-using-rollupjs)
  - [Run ArcGIS API using ESM + TypeScript using Webpack](#run-arcgis-api-using-esm--typescript-using-webpack)
...
This is the case of this demo app. Please check the [ts-amd-cdn-nobundler-noframework](../starter-apps/ts-amd-cdn-nobundler-noframework/) to better understand how to run to do it.

### Run ArcGIS API using ESM + Angular (TS)

[Check ts-esm-local-nobundler-angular](../starter-apps/ts-esm-local-nobundler-angular).

### Run ArcGIS API using ESM + TypeScript using Rollup.js

[Check ts-esm-local-rollup-noframework/](../starter-apps/ts-esm-local-rollup-noframework/).

### Run ArcGIS API using ESM + TypeScript using Webpack

[Check ts-esm-local-webpack-noframework/](../starter-apps/ts-esm-local-webpack-noframework/).
